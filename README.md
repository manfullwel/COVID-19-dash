...
### Empacotar projeto em ZIP (sem versionar binário no Git)
...
> Observação: o arquivo ZIP **não deve ser commitado** no repositório para evitar conflitos/limitações no editor web do GitHub com arquivos binários.
